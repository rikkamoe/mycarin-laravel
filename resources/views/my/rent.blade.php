                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td><img src="{{ url('img_uploads') }}/{{ $order_detail->car->img_car }}" class="img-fluid" alt="..."/></td>
                                        <td><h5>{{ $order_detail->car->name_car }}</h5></td>
                                        <td><h5>{{ $order_detail->rent }} Hari</h5></td>
                                        <td><h5>Rp. {{ number_format($order_detail->car->price_car) }}</h5></td>
                                        <td><h5>Rp. {{ number_format($order_detail->total_price) }}</h5></td>
                                        <td>
                                    ...
                                    @endforeach
                                    <tr>
                                        <td colspan="5" align="center"><h3>Total Harga</h3></td>
